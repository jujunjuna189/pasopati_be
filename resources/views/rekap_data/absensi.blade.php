        ...
        <div class="card">
            ...
            <div class="card-footer d-flex align-items-center">
                ...
                <ul class="pagination m-0 ms-auto">
                    <li class="page-item">
                        <a class="page-link" href="{{$controller->prevPagination($report->currentPage(), 'report.absensi')->link}}">
                    ...
                    @foreach($controller->counterPagination($report->lastPage(), $report->currentPage(), 'report.absensi') as $val)
                    <li class="page-item {{$val->is_active ? 'active' : ''}}"><a class="page-link" href="{{$val->link}}">{{$val->lable}}</a></li>
                    @endforeach
                    <li class="page-item">
                        <a class="page-link" href="{{$controller->nextPagination($report->currentPage(), $report->lastPage(), 'report.absensi')->link}}">
                            next
